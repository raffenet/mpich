                                         ...
                                         int *n_vnis_provided)
{
    ...
    *n_vnis_provided = 1;
    ...
    if (do_av_insert) {
        ...
        MPIDU_shm_seg_alloc(size * MPIDI_Global.addrnamelen, (void **)&MPIDI_Global.table);
        MPIDU_shm_seg_commit(&MPIDI_Global.memory, &MPIDI_Global.barrier, num_local, local_rank, local_rank_0, rank);
        table = MPIDI_Global.table;
