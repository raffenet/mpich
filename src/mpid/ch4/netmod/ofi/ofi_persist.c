...
int MPIDI_OFI_mpi_send_init(const void *buffer, MPI_Aint count,
...
int MPIDI_OFI_mpi_ssend_init(const void *buffer, MPI_Aint count,
                             MPI_Datatype datatype, int dest, int tag,
                             MPIR_Comm * comm, int context_offset, MPIR_Request ** request)
{
...
int MPIDI_OFI_mpi_bsend_init(const void *buffer, MPI_Aint count,
                             MPI_Datatype datatype, int dest, int tag,
                             MPIR_Comm * comm, int context_offset, MPIR_Request ** request)
{
...
int MPIDI_OFI_mpi_rsend_init(const void *buffer, MPI_Aint count,
                             MPI_Datatype datatype, int dest, int tag,
                             MPIR_Comm * comm, int context_offset, MPIR_Request ** request)
{
